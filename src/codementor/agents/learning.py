...
def build_learning_prompt(
    ...
    return (
        ...
        "keine Lerninhalte.\n"
        "- WICHTIG — Namens-Wiederverwendung: Prüfe für JEDES Konzept zuerst, ob es inhaltlich "
        "einem Eintrag in BEREITS BEKANNTE KONZEPTE entspricht, auch wenn du es anders formulieren "
        "würdest (z.B. entspricht 'ZeroDivisionError-Behandlung' dem bekannten 'Exception-Handling "
        "mit try-except für ZeroDivisionError'; 'Typ-Hinweise (float | None)' dem bekannten "
        "'Typ-Hinweise in Python (int | None)'). Wenn ja: verwende ZEICHENGENAU den bekannten "
        "Namen aus der Liste — sonst zersplittert der Lernfortschritt des Studierenden über "
        "Namensvarianten. Erfinde NIE eine neue Variante eines bereits bekannten Konzeptnamens. "
        "Nur wirklich NEUE Konzepte bekommen einen neuen Namen.\n"
        ...
        "OUTPUT-SCHEMA (JSON): \n"
        "[{\"concept\": str, \"difficulty\": \"easy\" | \"medium\" | \"hard\", \"reason\": str}]\n"
